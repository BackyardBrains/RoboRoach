...
/*
 *  This file is the primary header file for the Sensible TableView framework.
 *  It is the only file needed to be imported in order to start using the framework.
 */
...
#import <SensibleTableView/SCMemoryStore.h> 
